...
#ifndef ImportBIOrderH
#define ImportBIOrderH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
class TfrmimptBIorder : public TfrmMDIChild
{
...
public:		// User declarations
	__fastcall TfrmimptBIorder(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TfrmimptBIorder *frmimptBIorder;
//---------------------------------------------------------------------------
#endif
