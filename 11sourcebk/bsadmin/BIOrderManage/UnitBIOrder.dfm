object frmBIorder: TfrmBIorder
    ...
    object dgdetail: TDBGridEh
      ...
      Columns = <
        ...
        item
          ...
          FieldName = 'confrimcg'
          Footers = <>
          Title.Caption = #30830#35748#37319#36141
          Width = 54
        end
        item
          EditButtons = <>
  ...
  object ImageList1: TImageList
    ...
    Top = 312
    Bitmap = {
      494C01012A0048008C0110001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object aqorderdetail: TADOQuery
    ...
    SQL.Strings = (
        ...
        'price,B.pressID,A.amount,A.Discount,A.localnum,A.xuxiao,A.class,' +
        'A.newbook,'
        ...
        ' state1,B.PressCount,B.UserDefCode,B.Author,A.yprice,'
      
        'A.xiaoqu,A.xueyuan,A.course,A.incode,A.teacher,A.telphone,A.need' +
        'procurenum,'
      
        'A.baoxiao,A.xiankuan,A.confrimcg,A.clientbk,A.ystate,A.yamount,A' +
        '.ylocalnum,'
      
        ' sum(stk_bookinfo.amount) as bookamount,C.usableamount, A.needpr' +
        'ocurenum  as prostate '
      ' from BS_OrderNote A'
      ...
      'left join bs_pressinfo P ON B.pressID = P.ID'
        ...
        'left join stk_bookinfo on A.bkcatalogid = stk_bookinfo.bkcatalog' +
        'id and BS_OrderNoteHeader.stgid = stk_bookinfo.stgid'
      
        'left join Order_lock C on A.bkcatalogID = C.BkcatalogID and BS_O' +
        'rderNoteHeader.stgid = C.stgid'
      'where A.orderNtHeaderID =  :ID'
      
        'group by A.ID , A.OrderNtHeaderID,B.ISBN,B.name ,P.AbbreviatedNa' +
        'me,B.price,B.pressID,A.amount,A.Discount,A.localnum,A.xuxiao,A.c' +
        'lass,A.newbook,'
      
        'A.FixedPrice,A.Discountedprice,A.bk , A.bkcatalogid,A.SendAmount' +
        ',A.UnSendAmount,A.state,B.PressCount,B.UserDefCode,B.Author,A.yp' +
        'rice,'
        ...
        'A.baoxiao,A.xiankuan,A.confrimcg,A.clientbk,A.ystate,A.yamount,A' +
        '.ylocalnum,'
      'C.usableamount, A.needprocurenum')
    Left = 272
    Top = 400
  end
  ...
  object pm1: TPopupMenu
    ...
    object N15: TMenuItem
      Caption = #32479#19968#29256#21035
      OnClick = N15Click
    end
  ...
  object pmprview: TPopupMenu
    Left = 528
    Top = 480
    object N17: TMenuItem
      Caption = #25315#36135#21333
      OnClick = N17Click
    end
  end
  object pmshenhei: TPopupMenu
    Left = 608
    Top = 48
