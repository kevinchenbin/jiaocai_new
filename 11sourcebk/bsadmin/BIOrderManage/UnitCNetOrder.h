...
#ifndef UnitCNetOrderH
#define UnitCNetOrderH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
#include "pdtypes.h"
//---------------------------------------------------------------------------
class TfrmCNetOrder : public TForm
{
...
public:		// User declarations
	__fastcall TfrmCNetOrder(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TfrmCNetOrder *frmCNetOrder;
//---------------------------------------------------------------------------
#endif
