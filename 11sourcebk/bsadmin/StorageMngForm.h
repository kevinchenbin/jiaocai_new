...
__published:	// IDE-managed Components
	...
	TLabel *Label15;
	TEdit *totalnum;
	TADOStoredProc *adogetTotalNum;
	TEdit *edittotalmayang;
	TEdit *editshiyang;
	TLabel *Label16;
	TLabel *Label17;
  ...
  //	void __fastcall RzToolButton5Click(TObject *Sender);
	...
	void __fastcall cbckuweiSelect(TObject *Sender);
...
public:		// User declarations
   ...
   //	bool AddNote(int id);//添加单
		...
		AnsiString catalogidlist;
		  ...
		  int GetKuWeizuijing(int bkcatalogid,int supplierid, int stgid,int &ckuwei);
          void GetTotalNum(int headid);
};
//---------------------------------------------------------------------------
