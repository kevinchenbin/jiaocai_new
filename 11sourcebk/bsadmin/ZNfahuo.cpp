...
void __fastcall TfrmZNfahuo::SpeedButton1Click(TObject *Sender)
{
//CÍø
Tfrmzinengfahuo *frm = new Tfrmzinengfahuo(Application,linfo.con,linfo.storageID,linfo.userID);
 frm->Show();
}
//---------------------------------------------------------------------------
