	...
	switch (pgcntrlResult->ActivePage->Tag) {
		...
		case 2:
			...
			((TFloatField *)dbgrdByNote->DataSource->DataSet->FieldByName("salecbprice"))->DisplayFormat = Desic;
			 ...
			 {
					((TFloatField *)dbgridnotandan->DataSource->DataSet->FieldByName("FixedPrice"))->DisplayFormat = Desic;
			((TFloatField *)dbgridnotandan->DataSource->DataSet->FieldByName("DiscountedPrice"))->DisplayFormat = Desic;
			((TFloatField *)dbgridnotandan->DataSource->DataSet->FieldByName("Discount"))->DisplayFormat = Desic;
			((TFloatField *)dbgridnotandan->DataSource->DataSet->FieldByName("profite"))->DisplayFormat = Desic;
			((TFloatField *)dbgridnotandan->DataSource->DataSet->FieldByName("salecbprice"))->DisplayFormat = Desic;
