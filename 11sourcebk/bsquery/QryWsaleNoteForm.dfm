inherited frmQryWsaleNote: TfrmQryWsaleNote
  ...
  inherited grpbx1: TRzGroupBox
    ...
    object spselectClient: TSpeedButton [6]
      Left = 668
      Top = 99
      Width = 23
      Height = 21
    ...
    inherited dtedtStart: TRzDateTimeEdit
      Left = 77
      Width = 122
      ExplicitLeft = 77
      ExplicitWidth = 122
    ...
    inherited dtedtEnd: TRzDateTimeEdit
      Left = 77
      Top = 45
      Width = 122
      ExplicitLeft = 77
    ...
    inherited dblkpcbbBookType: TRzDBLookupComboBox
      Left = 614
      Top = 45
      Width = 76
      ExplicitLeft = 614
    ...
    object dblkpcbbSupplierID: TRzDBLookupComboBox [39]
      Left = 117
      Top = 100
      Width = 258
      Height = 21
    ...
    inherited cbkaipiao: TComboBox
      Visible = False
    end
    inherited ckkaipiao: TCheckBox
      Visible = False
    end
    object chyewuyuan: TCheckBox
      Left = 878
      Top = 74
      Width = 55
      Height = 17
  ...
  inherited pgcntrlResult: TRzPageControl
      ...
      inherited dbgrdByNtHeader: TDBGridEh
        ...
        Columns = <
          ...
          item
            ...
            Title.Caption = #39044#32422#26102#38388
            Width = 70
          end
          item
            EditButtons = <>
          ...
          item
            ...
            Footers = <>
            Title.Alignment = taCenter
            Title.Caption = #24050#20184#27454#37329#39069
            Width = 60
          end
          item
            EditButtons = <>
            ...
            Footers = <>
            Title.Alignment = taCenter
            Title.Caption = #24453#20184#27454#37329#39069
            Width = 60
          end
          item
            EditButtons = <>
    ...
    inherited tbshtByNote: TRzTabSheet
      ...
      object dbgridnotandan: TDBGridEh
        Left = 0
        Top = 0
        Width = 1025
        Height = 537
  ...
  inherited dsetSupplier: TADODataSet
    CommandText = 
      'select ID, Name from CUST_CustomerInfo where  Type =1  order by ' +
      'name'
  end
