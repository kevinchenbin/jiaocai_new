inherited frmPayDocQuery: TfrmPayDocQuery
  Caption = 'frmPayDocQuery'
  ClientHeight = 506
  ExplicitWidth = 859
  ExplicitHeight = 540
  PixelsPerInch = 96
  ...
  object rzgrpbx1: TRzGroupBox [12]
    Left = 0
    Top = 120
    Width = 833
    Height = 146
    Caption = #20379#24212#21830#32467#27454#21333#20449#24687
    TabOrder = 6
    object rzdbgrd1: TRzDBGrid
      ...
      TitleFont.Name = 'Tahoma'
      TitleFont.Style = []
      OnColumnMoved = rzdbgrd3ColumnMoved
      OnDblClick = rzdbgrd1DblClick
      FrameColor = 12164479
      FrameVisible = True
      Columns = <
