...
#ifndef selectdiaobookH
#define selectdiaobookH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class Tfrmfinddiaobook : public TfrmModalDialog
{
...
public:		// User declarations
	__fastcall Tfrmfinddiaobook(TComponent* Owner,TADOQuery *aq);
	bool SelectAll;
	AnsiString Supplier;
...
//---------------------------------------------------------------------------
extern PACKAGE Tfrmfinddiaobook *frmfinddiaobook;
//---------------------------------------------------------------------------
#endif
