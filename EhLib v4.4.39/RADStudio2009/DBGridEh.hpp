...
// (DO NOT EDIT: machine generated header) 'Dbgrideh.pas' rev: 20.00
...
private:
	...
	Graphics::TColor __fastcall GetColor(void);
	Graphics::TFont* __fastcall GetFont(void);
	System::Variant __fastcall GetSumValue();
	bool __fastcall GetToolTips(void);
	bool __fastcall IsAlignmentStored(void);
	bool __fastcall IsColorStored(void);
	bool __fastcall IsFontStored(void);
...
protected:
	...
	virtual System::UnicodeString __fastcall GetExpressionAsString();
	virtual bool __fastcall DropDownButtonVisible(void);
	void __fastcall InternalSetExpressionStr(const System::UnicodeString Value);
...
public:
	...
	virtual System::Variant __fastcall GetOperand1();
	virtual System::Variant __fastcall GetOperand2();
	System::UnicodeString __fastcall CurrentKeyField();
	System::UnicodeString __fastcall CurrentDataField();
	Db::TDataSet* __fastcall CurrentListDataSet(void);
	System::UnicodeString __fastcall CurrentListField();
	virtual void __fastcall Assign(Classes::TPersistent* Source);
...
private:
	...
	Controls::TImeName __fastcall GetImeName();
...
protected:
	...
	System::UnicodeString __fastcall DefaultLookupDisplayFields();
	bool __fastcall DefaultToolTips(void);
	bool __fastcall DefaultWordWrap(void);
	bool __fastcall GetAutoFitColWidth(void);
	virtual System::UnicodeString __fastcall GetDisplayName();
	TCustomDBGridEh* __fastcall GetGrid(void);
	System::UnicodeString __fastcall GetLookupDisplayFields();
...
public:
	...
	Controls::TImeName __fastcall DefaultImeName();
...
private:
	...
	Sysutils::TBytes __fastcall GetBottomRow();
	int __fastcall GetLeftCol(void);
	int __fastcall GetRightCol(void);
	Sysutils::TBytes __fastcall GetTopRow();
...
protected:
	...
	DYNAMIC void __fastcall GetFooterParams(int DataCol, int Row, TColumnEh* Column, Graphics::TFont* AFont, Graphics::TColor &Background, Classes::TAlignment &Alignment, Gridseh::TGridDrawState State, System::UnicodeString &Text);
...
public:
	...
	System::UnicodeString __fastcall GetCompleteKeyPress();
...
#define ColumnEhTitleValues (Set<TColumnEhValue, cvColor, cvBiDiMode> () << cvTitleColor << cvTitleCaption << cvTitleAlignment << cvTitleFont << cvTitleButton << cvTitleEndEllipsis << cvTitleToolTips << cvTitleOrientation )
