...
// (DO NOT EDIT: machine generated header) 'Memtabledataeh.pas' rev: 20.00
...
protected:
	...
	virtual System::UnicodeString __fastcall DefValueForDefaultExpression();
	virtual System::UnicodeString __fastcall DefaultDisplayLabel();
	...
	virtual System::UnicodeString __fastcall GetDefaultExpression();
	virtual System::UnicodeString __fastcall GetDisplayLabel();
	virtual int __fastcall GetDisplayWidth(void);
	virtual System::UnicodeString __fastcall GetEditMask();
...
private:
	...
	System::UnicodeString __fastcall GetParentFieldNames();
...
private:
	...
	System::UnicodeString __fastcall GetSortOrder();
...
extern PACKAGE StaticArray<TMTDataFieldClassEh, 49> DefaultDataFieldClasses;
