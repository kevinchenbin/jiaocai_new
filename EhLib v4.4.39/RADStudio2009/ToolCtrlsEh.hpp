...
// (DO NOT EDIT: machine generated header) 'Toolctrlseh.pas' rev: 20.00
...
protected:
	...
	Sysutils::TBytes __fastcall CurrentRow();
...
typedef Set<Db::TFieldType, Db::ftUnknown, ftStream>  TFieldTypes;
